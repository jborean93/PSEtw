...
Describe "Register-PSEtwEvent" -Skip:(-not $IsAdmin) {
    ...
    It "Receives simple event" {
        ...
        try {
            ...
            while ($true) {
                ...
                if ($actual.SourceEventArgs.ProviderId -ne '68fdd900-4a3e-11d1-84f4-0000f80464e3') {
                    break
                }
            }
            ...
            $ea.ProviderId | Should -BeOfType ([guid])
            $ea.ProviderId | Should -Be 1054782c-5461-554b-15c9-8d36ab0c3097
            $ea.ProviderName | Should -Be PSEtw-TraceLogger
            $ea.ThreadId | Should -BeOfType ([int])
            $ea.ProcessId | Should -BeOfType ([int])
            $ea.TimeStamp | Should -BeOfType ([DateTime])
            $ea.TimeStamp.Kind | Should -Be Utc
            $ea.ActivityId | Should -BeOfType ([guid])
            $ea.Id | Should -Be 0
            $ea.Version | Should -Be 0
            $ea.Channel | Should -Be 11
            $ea.ChannelName | Should -BeNullOrEmpty
            $ea.Level | Should -Be 4
            $ea.LevelName | Should -BeNullOrEmpty
            $ea.OpCode | Should -Be 0
            $ea.OpCodeName | Should -BeNullOrEmpty
            $ea.Task | Should -Be 0
            $ea.TaskName | Should -Be MyEvent
            $ea.Keyword | Should -Be 1
            $ea.KeywordNames.Count | Should -Be 0
            $ea.Tags | Should -Be 0
            $ea.EventData | Should -BeNullOrEmpty
            $ea.Properties.Count | Should -Be 1
            $ea.Properties[0].Name | Should -Be 'String Property'
            $ea.Properties[0].Value | Should -BeOfType ([string])
            $ea.Properties[0].Value | Should -Be value
            $ea.Properties[0].DisplayValue | Should -Be value
            $ea.Properties[0].Tags | Should -Be 20
            $ea.Properties[0].ToString() | Should -Be 'String Property=value'
            $ea.EventMessage | Should -BeNullOrEmpty
        }
        finally {
    ...
    It "Registers an action" {
        ...
        try {
            ...
            $actual | Should -Not -BeNullOrEmpty
            $actual.MessageData.Id | Should -Be 1
            $actual.MessageData.Properties[0].Name | Should -Be myId
            $actual.MessageData.Properties[0].Value | Should -Be 10
    ...
    It "Filters by level" {
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 4
            $actual.SourceEventArgs.Level | Should -Be 2
            $actual.SourceEventArgs.LevelName | Should -Be Error
            $actual.SourceEventArgs.Properties[0].Name | Should -Be myId
            $actual.SourceEventArgs.Properties[0].Value | Should -Be 20
        }
        finally {
            Unregister-Event -SourceIdentifier $sourceId
        }
    ...
    It "Filters by KeywordNames any" {
        $sourceId = [Guid]::NewGuid()
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 9
            $actual.SourceEventArgs.Keyword | Should -Be 0x0000F00000000002
            $actual.SourceEventArgs.KeywordNames.Count | Should -Be 1
            @($actual.SourceEventArgs.KeywordNames[0]) | Should -Be Bar
            $actual.SourceEventArgs.Properties[0].Name | Should -Be myId
            $actual.SourceEventArgs.Properties[0].Value | Should -Be 20
        }
        finally {
    ...
    It "Filters by KeywordNames all" {
        $sourceId = [Guid]::NewGuid()
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 10
            $actual.SourceEventArgs.Keyword | Should -Be 0x0000F00000000003
            $actual.SourceEventArgs.KeywordNames.Count | Should -Be 2
            $actual.SourceEventArgs.KeywordNames[0] | Should -Be Foo
            $actual.SourceEventArgs.KeywordNames[1] | Should -Be Bar
            $actual.SourceEventArgs.Properties[0].Name | Should -Be myId
            $actual.SourceEventArgs.Properties[0].Value | Should -Be 20
        }
        finally {
    ...
    It "Parses multiple value types" {
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 11
            $actual.SourceEventArgs.Properties.Count | Should -Be 21

            $prop = $actual.SourceEventArgs.Properties[0]
            ...
            $prop = $actual.SourceEventArgs.Properties[1]
            ...
            $prop = $actual.SourceEventArgs.Properties[2]
            ...
            $prop = $actual.SourceEventArgs.Properties[3]
            ...
            $prop = $actual.SourceEventArgs.Properties[4]
            ...
            $prop = $actual.SourceEventArgs.Properties[5]
            ...
            $prop = $actual.SourceEventArgs.Properties[6]
            ...
            $prop = $actual.SourceEventArgs.Properties[7]
            ...
            $prop = $actual.SourceEventArgs.Properties[8]
            ...
            $prop = $actual.SourceEventArgs.Properties[9]
            ...
            $prop = $actual.SourceEventArgs.Properties[10]
            ...
            $prop = $actual.SourceEventArgs.Properties[11]
            ...
            $prop = $actual.SourceEventArgs.Properties[12]
            ...
            $prop = $actual.SourceEventArgs.Properties[13]
            ...
            $prop = $actual.SourceEventArgs.Properties[14]
            ...
            $prop = $actual.SourceEventArgs.Properties[15]
            ...
            $prop = $actual.SourceEventArgs.Properties[16]
            ...
            $prop = $actual.SourceEventArgs.Properties[17]
            ...
            $prop = $actual.SourceEventArgs.Properties[18]
            ...
            $prop = $actual.SourceEventArgs.Properties[19]
            ...
            $prop = $actual.SourceEventArgs.Properties[20]
    ...
    It "Parses string types" {
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 12
            $actual.SourceEventArgs.EventMessage | Should -Be "Event Message 'string 1', 'Caf$([char]0xE9)s', 'string 3 with unicode $([Char]::ConvertFromUtf32(0x1F3B5))'"
            $actual.SourceEventArgs.Properties.Count | Should -Be 3
    ...
    It "Parses struct types" {
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 0
            $actual.SourceEventArgs.Properties.Count | Should -Be 3
    ...
    # EventSource on WinPS doesn't handle $null properly, will produce an invalid payload
    # Just skip this test on that version.
    It "Formats property after empty string value" -Skip:($PSVersionTable.PSVersion -lt '6.0') {
        $sourceId = [Guid]::NewGuid()
        $registerOutput = Register-PSEtwEvent -Provider PSEtw-Manifest -SourceIdentifier $sourceId
        try {
            $registerOutput | Should -BeNullOrEmpty
            ...
            $prop.Value | Should -BeOfType ([string])
            $prop.DisplayValue | Should -Be foo
            $prop.ToString() | Should -Be 'arg1=foo'

            $prop = $actual.SourceEventArgs.Properties[1]
            $prop.Name | Should -Be 'arg2'
            $prop.Value | Should -Be ""
            $prop.Value | Should -BeOfType ([string])
            $prop.DisplayValue | Should -Be ""
            $prop.ToString() | Should -Be 'arg2='
            ...
            $prop.Value | Should -BeOfType ([string])
            $prop.DisplayValue | Should -Be bar
            $prop.ToString() | Should -Be 'arg3=bar'
        }
        finally {
            Unregister-Event -SourceIdentifier $sourceId
        }
    ...
    It "Uses a custom ETW session" {
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 1
            $actual.SourceEventArgs.Properties[0].Name | Should -Be myId
            $actual.SourceEventArgs.Properties[0].Value | Should -Be 10
        }
        finally {
    ...
    It "Uses custom tag" {
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 0
            $actual.SourceEventArgs.Properties[0].Name | Should -Be UnicodeString
            $actual.SourceEventArgs.Properties[0].Value | Should -Be value
            $actual.SourceEventArgs.Properties[0].Tags | Should -Be 10
        }
        finally {
            Unregister-Event -SourceIdentifier $sourceId
        }
    ...
    It "Decodes custom types from trace logger" {
        ...
        try {
            ...
            $eb.AddFileTime(
                ...
                0)
            $eb.AddInt32(
                "AddInt32AsBooleanTrue",
                0x00FF0000,
                [Microsoft.TraceLoggingDynamic.EventOutType]::Boolean,
                0)
            $eb.AddInt32(
                "AddInt32AsBooleanFalse",
                0,
                [Microsoft.TraceLoggingDynamic.EventOutType]::Boolean,
                0)
            $eb.AddUnicodeString("AddUnicodeStringLong", "a" * 2048, $defaultOut, 0)
            ...
            $actual.SourceEventArgs.Properties.Count | Should -Be 45
            ...
            $prop = $actual.SourceEventArgs.Properties[21]
            ...
            $prop = $actual.SourceEventArgs.Properties[22]
            ...
            $prop = $actual.SourceEventArgs.Properties[23]
            ...
            $prop = $actual.SourceEventArgs.Properties[24]
            ...
            $prop = $actual.SourceEventArgs.Properties[25]
            ...
            $prop = $actual.SourceEventArgs.Properties[26]
            ...
            $prop = $actual.SourceEventArgs.Properties[27]
            ...
            $prop = $actual.SourceEventArgs.Properties[28]
            ...
            $prop = $actual.SourceEventArgs.Properties[29]
            ...
            $prop = $actual.SourceEventArgs.Properties[30]
            ...
            $prop = $actual.SourceEventArgs.Properties[31]
            ...
            $prop = $actual.SourceEventArgs.Properties[32]
            ...
            $prop = $actual.SourceEventArgs.Properties[33]
            ...
            $prop = $actual.SourceEventArgs.Properties[34]
            ...
            $prop = $actual.SourceEventArgs.Properties[35]
            ...
            $prop = $actual.SourceEventArgs.Properties[36]
            ...
            $prop = $actual.SourceEventArgs.Properties[37]
            ...
            $prop = $actual.SourceEventArgs.Properties[38]
            ...
            $prop = $actual.SourceEventArgs.Properties[39]
            ...
            $prop = $actual.SourceEventArgs.Properties[40]
            ...
            $prop = $actual.SourceEventArgs.Properties[41]
            ...
            $prop = $actual.SourceEventArgs.Properties[42]
            $prop.Name | Should -Be AddInt32AsBooleanTrue
            $prop.Value | Should -BeTrue
            $prop.Value | Should -BeOfType ([bool])
            $prop.DisplayValue | Should -Be "16711680"
            $prop.ToString() | Should -Be "AddInt32AsBooleanTrue=16711680"

            $prop = $actual.SourceEventArgs.Properties[43]
            $prop.Name | Should -Be AddInt32AsBooleanFalse
            $prop.Value | Should -BeFalse
            $prop.Value | Should -BeOfType ([bool])
            $prop.DisplayValue | Should -Be "0"
            $prop.ToString() | Should -Be "AddInt32AsBooleanFalse=0"

            $prop = $actual.SourceEventArgs.Properties[44]
            $prop.Name | Should -Be AddUnicodeStringLong
            $prop.Value | Should -Be ("a" * 2048)
            $prop.Value | Should -BeOfType ([string])
            $prop.DisplayValue | Should -Be ("a" * 2048)
            $prop.ToString() | Should -Be ("AddUnicodeStringLong=" + ("a" * 2048))
        }
        finally {
            Unregister-Event -SourceIdentifier $sourceId
        }
    ...
    It "Does not crash when parsing an invalid value" {
        ...
        try {
            ...
            $actual.SourceEventArgs.Id | Should -Be 0
            $actual.SourceEventArgs.TaskName | Should -Be MyFailedEvent
            $actual.SourceEventArgs.Properties.Count | Should -Be 0
            $actual.SourceEventArgs.EventMessage | Should -BeLike "Failed to unpack EventData due to unhandled exception: Data at the root level is invalid. Line 1, position 1.*"
            ...
            $actual.SourceEventArgs.Id | Should -Be 0
            $actual.SourceEventArgs.TaskName | Should -Be MyGoodEvent
            $actual.SourceEventArgs.Properties[0].Name | Should -Be UnicodeString
            $actual.SourceEventArgs.Properties[0].Value | Should -Be value
            $actual.SourceEventArgs.Properties[0].Tags | Should -Be 10
        }
